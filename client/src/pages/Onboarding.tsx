    ...
    <>
      ...
      <div className="onboarding-container">
        <div className="p-6 pt-12 onboarding-wrapper"> 
          ...
          <p className="text-slate-500 mt-4">Let's personalize your experience</p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 mb-8">
                ...
                border border-emerald-100 flex items-center justify-center">
                  <User className="size-6 text-emerald-600"/></div>
                <div >
                  <h2 className="text-lg font-semibold text-slate-800">How old are you?</h2>
                  <p className="text-slate-500 text-sm">This helps us calculate your needs</p>
                </div>
              </div>
          ...
          {step === 2 && (
            <div className="space-y-6 onboarding-wrapper">
              <div className="flex items-center gap-4 mb-8">
                <div className="size-12 rounded-xl bg-emerald-50
                border border-emerald-100 flex items-center justify-center">
                  <ScaleIcon className="size-6 text-emerald-600"/></div>
                <div >
                  <h2 className="text-lg font-semibold text-slate-800">Your measurements</h2>
                  <p className="text-slate-500 text-sm">Help us track your progress</p>
                </div>
              </div>
              <div className="flex flex-col gap-4 max-w-2xl">
                  <Input label="Weight (kg)" type="number"
                  value={formData.weight} onChange={(v)=>{updateField('weight',v)}} placeholder="Enter your weight"
                  min={20} max={300} required/>

                  <Input label="Height (Cm)" type="number"
                  value={formData.height} onChange={(v)=>{updateField('height',v)}} placeholder="Enter your height"
                  min={100} max={250} />
              </div>
          ...
          {step === 3 && (
            <div className="space-y-6 onboarding-wrapper">
              <div className="flex items-center gap-4 mb-8">
                <div className="size-12 rounded-xl bg-emerald-50
                border border-emerald-100 flex items-center justify-center">
                  <Target className="size-6 text-emerald-600"/></div>
                <div >
                  <h2 className="text-lg font-semibold text-slate-800">What's your goal?</h2>
                  <p className="text-slate-500 text-sm">We'll tailor your experience</p>
                </div>
              </div>
              ...
              <div className="border-t border-slate-200 my-6 max-w-lg"></div>

              <div className="space-y-8 max-w-lg">
                <h3 className="text-md font-medium text-slate-800 mb-4">Daily Targets</h3>
        ...
        <div className="p-6 pb-10 onboarding-wrapper">
          <div className="flex gap-3 lg:jsutify-end">
            {step > 1 &&(
